...
/**
 * This class contains the code that represents a Wardrobe. A Wardrobe object contains
 * and manages Clothing. For use in the Wardrobe Manager project.
 */
...
public class Wardrobe {
    ...
    /**
     * This method finds and returns the piece of clothing with the matching description and 
     * brand. The comparisons are case-insensitive.
     * 
    ...
    /**
     * This method adds a piece of clothing at the end of the wardrobe. If the wardrobe does not
     * have room for the piece of clothing, the wardrobe expands by doubling in capacity then
     * adds the new piece of clothing.
     * 
     * @param toAdd the piece of clothing to add to the wardrobe
     */
    public void addClothing(Clothing toAdd) {
        ...
        if (containsClothing(toAdd)) {
            throw new IllegalArgumentException("This clothe already exists in the wardrobe.");
        }
    ...
    /**
     * This method wears the piece of Clothing in this Wardrobe equal to the provided Clothing on
     * the given date.
     * 
    ...
    /**
     * This method removes the piece of clothing from the wardrobe that has a matching description
     * and brand.
     * 
    ...
    /**
     * This method removes all pieces of clothing from the wardrobe whose last worn date is BEFORE
    ...
    public void removeAllClothingWornBefore(int year, int month, int day) {
        ...
        for (int i = 0; i < wardrobeSize; i++) {
            if (wardrobe[i] != null && wardrobe[i].getLastWornDate() != null) {
                if (wardrobe[i].getLastWornDate().isBefore(date)) {
                    removeItem(i);
                    i--;
                }
            }
    ...
    /**
     * This method removes all pieces of clothing from the wardrobe who have been worn less times
    ...
    /**
     * This method Creates a new Clothing object based on the given String formatted
     * as "description,brand,lastWornDate,timesWorn".
     * 
     ...
     */
    public static Clothing parseClothing(String str) {
    ...
    /**
     * This method Loads all of pieces of clothing into this wardrobe from the designated file. 
     * Each piece of clothing in the Wardrobe is written on its own line, 
     * formatted as description,brand,lastWornDate,timesWorn.
     * 
     * @param saveFile the File that the information should be read from
     * @return true if ANY of the lines from the file were parsed successfully into Clothing
     * for this Wardrobe, false otherwise
     */
    ...
    /**
     * This method Saves all of pieces of clothing in this wardrobe to the designated file. 
     * Each piece of clothing in the Wardrobe is written on its own line, 
     * formatted as description,brand,lastWornDate,timesWorn. 
     * 
          ...
          for (int i = 0; i < wardrobeSize; i++) {
              ...
              if (clothing != null) {
                  ...
                  String line = clothing.getDescription() + "," + clothing.getBrand() + ","
                          + lastWornDate + "," + clothing.getNumOfTimesWorn();
                  writer.println(line);
              }
          }
          return true;
